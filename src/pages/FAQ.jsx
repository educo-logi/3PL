    ...
    const faqData = [
        ...
        },
        {
            ...
            items: [
                {
                    q: "아이디/비밀번호를 잊어버렸어요.",
                    a: "로그인 화면의 [아이디/비밀번호 찾기] 기능을 이용해 주세요.\n\n• **아이디 찾기**: 가입 시 입력한 [사업자등록번호 + 대표자명 + 대표연락처]를 입력해 주시면 가입된 이메일을 확인하실 수 있습니다.\n• **비밀번호 찾기**: [이메일 + 사업자등록번호 + 대표자명 + 대표연락처] 모두 일치할 경우 새 비밀번호로 즉시 재설정이 가능합니다."
                },
                {
                    q: "회원 탈퇴는 어떻게 하나요?",
