                    ...
                    <div className="p-8 space-y-8">
                        <section>
                            ...
                            <p className="text-gray-600 leading-relaxed">
                                (주)동화세상에듀코는 "전자상거래 등에서의 소비자보호에 관한 법률" 등 관련 법령을 준수합니다. 회원이 열람권 서비스를 결제한 후 서비스를 전혀 이용하지 않은 경우, 결제일로부터 7일 이내에 청약 철회(전액 환불)가 가능합니다. 단, 디지털 콘텐츠 특성상 1회 이상의 정보 열람이 발생한 경우 서비스 이용이 개시된 것으로 간주하여 환불이 제한됩니다.
                            </p>
                        </section>
