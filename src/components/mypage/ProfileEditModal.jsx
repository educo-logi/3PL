                            ...
                            <div className="space-y-6 animate-fadeIn">
                                <div className="bg-gray-50 p-5 rounded-lg border">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div><label className="text-xs text-gray-500 mb-1 block">보유 파렛트 수</label><input type="number" name="pallet_count" value={formData.pallet_count || ''} onChange={handleInputChange} className="w-full px-3 py-2 border rounded-lg" placeholder="PLT" /></div>
                            ...
                            <div className="space-y-6 animate-fadeIn">
                                <div className="bg-gray-50 p-5 rounded-lg border">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div><label className="text-xs text-gray-500 mb-1 block">보관 파렛트 수</label><input type="number" name="pallet_count" value={formData.pallet_count || ''} onChange={handleInputChange} className="w-full px-3 py-2 border rounded-lg" placeholder="PLT" /></div>
                                    </div>
                                </div>
